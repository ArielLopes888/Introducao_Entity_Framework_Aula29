...
namespace Aula29.Controllers
{
    public class AtorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Sobrenome")] Ator atorModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Sobrenome")] Ator atorModel)
        {
            if (id != atorModel.Id)
            {
                return NotFound();
